namespace SeriousGameWPF
{
    public class GameMode : Displayable
    {
        ...
        public const double XSize = 100;//ViewBox méretét állítja, azért konstans mert futásidő előtt beállítja a viewbox méretét, de futásidőben kalkulálja a pozicíóját
        public const double YSize = 100;//ViewBox méretét állítja, azért konstans mert futásidő előtt beállítja a viewbox méretét, de futásidőben kalkulálja a pozicíóját
